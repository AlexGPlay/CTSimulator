...
public class MainWindowController implements Initializable, MemoryObserver, GPRObserver{
	...
	private void expandPane(TitledPane pane) {
        ...
        System.out.println(mainAccordion.getExpandedPane());
	}
	...
	@Override
	public void updateGPR(short[] data) {
		...
		for(int i=0;i<data.length;i++) {
			...
			if(i==7)
				temp = Translate.toMemoryPosition(Translate.toBinaryString(data[i], 16));
